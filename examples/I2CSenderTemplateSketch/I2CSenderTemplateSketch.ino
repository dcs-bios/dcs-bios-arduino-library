...
In this example, we will send the data to the I2C bus,
where another Arduino that is running the
I2CSerialBridgeTemplateSketch will pick it up and forward
it to the DCS computer.
*/
void sendDcsBiosMessage(const char* msg, const char* arg) {
